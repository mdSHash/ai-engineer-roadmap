    ...
    <section className="max-w-5xl mx-auto px-6 md:px-12 py-20 md:py-28">
      <FadeIn>
        ...
        <h1 className="font-serif text-display-lg text-ink-50 mt-4 mb-6">
          {interviewQuestions.length} scenarios. <span className="text-lime-accent">Four ways to drill.</span>
        </h1>
      ...
      <FadeIn delay={0.15}>
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {mode === 'drill'  && <InterviewDrill   questions={interviewQuestions} categories={interviewCategories} />}
